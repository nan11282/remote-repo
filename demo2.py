...
def create_map(communities_open=True):
    ...
    # 设置主干道 - T字路口，主干道为垂直方向和水平方向东半部分
    grid_map[mid, mid:] = MAIN_ROAD  # Mid row from mid to end (E方向)
    grid_map[:, mid] = MAIN_ROAD      # Mid column full (N和S方向)
